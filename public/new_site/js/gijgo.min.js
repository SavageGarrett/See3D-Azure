...
(gj.widget = function () {
            ...
            ['d', 'dd'].indexOf(f[d]) > -1
              ...
              : ['m', 'mm'].indexOf(f[d]) > -1
                ...
                : 'mmm' === f[d]
                  ...
                  : 'mmmm' === f[d]
                    ? (i = gj.core.messages[c || 'en-us'].monthNames.indexOf(
                        e[d]
                      ))
        ...
        : 'icon' === c.type
          ...
          : c.tmpl
            ...
            : c.renderer && 'function' == typeof c.renderer
              ? (g = c.renderer(d[c.field], d, b.parent(), b, e, a)) &&
                b.html(g)
  ...
  (gj.grid.plugins.pagination = {
    config: {
      base: {
        style: {
          pager: { panel: '', stateDisabled: '', activeButton: '' },
        },
  ...
  (gj.tree.config = {
    ...
    materialicons: {
      style: { expander: 'gj-tree-material-icons-expander' },
    },
    fontawesome: {
  ...
  (gj.tree.plugins.lazyLoading = {
    config: {
      base: { paramNames: { parentId: 'parentId' }, lazyLoading: !1 },
    },
    private: {
      nodeDataBound: function (a, b, c, d) {
        var e = a.data(),
