	...
	<section class="container content-section text-center reset-top-padding">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
              <div>
                <img style="float: left;" src="../img_refactor/karen_cropped.jpg" alt="Caroline Karbowski">
              ...
              <div>
                <img style="float: left;" src="../img_refactor/karen_cropped.jpg" alt="Garrett Carder">
                <h3>Garrett Carder</h3>
                <p>M.S. Cognitive Neuroscience Ph.D. candidate, University of California Irvine From Los Angeles</p>
              </div>
              <div style="clear: left;"></div>
              <div>
                <img style="float: left;" src="../img_refactor/karen_cropped.jpg" alt="Emily Kiehl">
                <h3>Emily Kiehl</h3>
                <p>M.S. Cognitive Neuroscience Ph.D. candidate, University of California Irvine From Los Angeles</p>
              </div>
              <div style="clear: left;"></div>
